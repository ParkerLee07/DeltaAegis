...
The project focuses on reliable attack-surface change detection, asset-state tracking, alert review, risk prioritization, and Markdown investigation reporting before expanding into broader SIEM capabilities.
...
DeltaAegis v0.4.0 adds an explainable risk register for prioritizing review.
...
DeltaAegis v0.4.0 is a network-state monitoring, investigation, and risk prioritization prototype.
